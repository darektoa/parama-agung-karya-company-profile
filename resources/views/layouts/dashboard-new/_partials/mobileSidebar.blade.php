...
<aside
    ...
    <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <div class="my-6 px-6">
            <button
                class="flex items-center justify-between rounded-lg border border-transparent bg-purple-600 px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 hover:bg-purple-700 focus:outline-none focus:ring active:bg-purple-600">
                Create account
                <span
                    class="ml-2"
                    aria-hidden="true">
