<section
    class="portfolio-wthree align-w3"
    id="blog">
    <div class="container">
        <div class="wthree_pvt_title text-center">
            <h4 class="w3pvt-title">Blog</h4>
            <p class="sub-title">&nbsp;</p>
        </div>
                    ...
                    <a href="/blogs/1">
                        <div class="img-grid">
                            ...
                            <div class="port-desc text-center">
                                ...
                                <p>
                                    Lorem ipsum dolor sit amet,Stet clita kasd gubergren, sed diam voluptua. sed diam
                ...
                <li class="col-lg-4">
                    <div class="img-grid">
                        ...
                        <div class="port-desc text-center">
                            <h6 class="main-title-w3pvt text-center">Some Description</h6>
                            <p>
                                Lorem ipsum dolor sit amet,Stet clita kasd gubergren, sed diam voluptua. sed diam nonumy
